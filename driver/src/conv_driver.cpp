...
#include "device_convolution_implicit_gemm_v4r1_nchw_kcyx_nkhw_generic_asm.hpp"
...
int main(int argc, char* argv[])
{
    ...
    device_convolution_implicit_gemm_v4r1_nchw_kcyx_nkhw_generic_1x1_asm(in_nchw_desc,
                                                                     ...
                                                                     nrepeat);
#elif 1
    device_convolution_implicit_gemm_v4r1_nchw_kcyx_nkhw_generic_asm(in_nchw_desc,
                                                                     in_nchw,
                                                                     wei_kcyx_desc,
                                                                     wei_kcyx,
                                                                     out_nkhw_desc,
    ...
    device_convolution_implicit_gemm_v4r1_nchw_kcyx_nkhw_generic_nkc(in_nchw_desc,
                                                                     ...
                                                                     nrepeat);
#elif 0
    device_convolution_implicit_gemm_v4r1_nchw_kcyx_nkhw_generic_1x1(in_nchw_desc,
                                                                     in_nchw,
                                                                     wei_kcyx_desc,
                                                                     wei_kcyx,
                                                                     out_nkhw_desc,
