...
#include "device_convolution_implicit_gemm_v4r4_nchw_kcyx_nkhw_mp.hpp"

int main(int argc, char* argv[])
{
    using namespace ck;

    auto ff = [&]() -> void { std::cout << "ff:Hello world" << std::endl; };
    auto tt = [&]() -> void { std::cout << "tt: Hello world " << std::endl; };

    std::function<void()> R[] = {ff, tt};
#if 0
    // 1x1
    ...
    constexpr index_t HI = 57;
    constexpr index_t WI = 57;
    constexpr index_t K  = 256 + 32;
    constexpr index_t Y  = 1;
    constexpr index_t X  = 1;
    ...
    // 3x3
    constexpr index_t N  = 128;
    constexpr index_t C  = 144;
    constexpr index_t HI = 14;
    constexpr index_t WI = 14;
    constexpr index_t K  = 288;
