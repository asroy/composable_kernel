...
static std::string get_network_config_string_from_tunable(const tunable_dyn_conv_fwd_v4r5_nchw_kcyx_nkhw *pt)
{
    std::string out("TUN_");

    out += std::to_string(pt->BlockSize) + "_";

    out += std::to_string(pt->GM1PerBlockGM11) + "x" + std::to_string(pt->GN1PerBlockGN11) + "x" + std::to_string(pt->KPerBlock) + "_";
    out += std::to_string(pt->M1PerThread) + "x" + std::to_string(pt->N1PerThread) + "x" + std::to_string(pt->KPerThread) + "_";
    out += std::to_string(pt->M1N1ThreadClusterM10) + "x" + std::to_string(pt->M1N1ThreadClusterN10) + "x" +
           std::to_string(pt->M1N1ThreadClusterM11) + "x" + std::to_string(pt->M1N1ThreadClusterN11) + "_";

    out += std::to_string(pt->ABlockTransferThreadSliceLengths_GK_GM0_GM10_GM11[0]) + "x" + std::to_string(pt->ABlockTransferThreadSliceLengths_GK_GM0_GM10_GM11[1]) + "x" +
           std::to_string(pt->ABlockTransferThreadSliceLengths_GK_GM0_GM10_GM11[2]) + "x" + std::to_string(pt->ABlockTransferThreadSliceLengths_GK_GM0_GM10_GM11[3]) + "_";

    out += std::to_string(pt->ABlockTransferThreadClusterLengths_GK_GM0_GM10_GM11[0]) + "x" + std::to_string(pt->ABlockTransferThreadClusterLengths_GK_GM0_GM10_GM11[1]) + "x" +
           std::to_string(pt->ABlockTransferThreadClusterLengths_GK_GM0_GM10_GM11[2]) + "x" + std::to_string(pt->ABlockTransferThreadClusterLengths_GK_GM0_GM10_GM11[3]) + "_";

    out += std::to_string(pt->ABlockTransferThreadClusterArrangeOrder[0]) + "x" + std::to_string(pt->ABlockTransferThreadClusterArrangeOrder[1]) + "x" +
           std::to_string(pt->ABlockTransferThreadClusterArrangeOrder[2]) + "x" + std::to_string(pt->ABlockTransferThreadClusterArrangeOrder[3]) + "_";

    out += std::to_string(pt->ABlockTransferSrcAccessOrder[0]) + "x" + std::to_string(pt->ABlockTransferSrcAccessOrder[1]) + "x" +
           std::to_string(pt->ABlockTransferSrcAccessOrder[2]) + "x" + std::to_string(pt->ABlockTransferSrcAccessOrder[3]) + "_";
    ...
    out += std::to_string(pt->BBlockTransferThreadSliceLengths_GK_GN0_GN10_GN11[0]) + "x" + std::to_string(pt->BBlockTransferThreadSliceLengths_GK_GN0_GN10_GN11[1]) + "x" +
           std::to_string(pt->BBlockTransferThreadSliceLengths_GK_GN0_GN10_GN11[2]) + "x" + std::to_string(pt->BBlockTransferThreadSliceLengths_GK_GN0_GN10_GN11[3]); 

    out += std::to_string(pt->BBlockTransferThreadClusterLengths_GK_GN0_GN10_GN11[0]) + "x" + std::to_string(pt->BBlockTransferThreadClusterLengths_GK_GN0_GN10_GN11[1]) + "x" +
           std::to_string(pt->BBlockTransferThreadClusterLengths_GK_GN0_GN10_GN11[2]) + "x" + std::to_string(pt->BBlockTransferThreadClusterLengths_GK_GN0_GN10_GN11[3]) + "_";

    out += std::to_string(pt->BBlockTransferThreadClusterArrangeOrder[0]) + "x" + std::to_string(pt->BBlockTransferThreadClusterArrangeOrder[1]) + "x" +
           std::to_string(pt->BBlockTransferThreadClusterArrangeOrder[2]) + "x" + std::to_string(pt->BBlockTransferThreadClusterArrangeOrder[3]) + "_";

    out += std::to_string(pt->BBlockTransferSrcAccessOrder[0]) + "x" + std::to_string(pt->BBlockTransferSrcAccessOrder[1]) + "x" +
           std::to_string(pt->BBlockTransferSrcAccessOrder[2]) + "x" + std::to_string(pt->BBlockTransferSrcAccessOrder[3]) + "_";
    ...
    out += std::to_string(pt->CThreadTransferSrcDstAccessOrder[0]) + "x" + std::to_string(pt->CThreadTransferSrcDstAccessOrder[1]) + "x" +
           std::to_string(pt->CThreadTransferSrcDstAccessOrder[2]) + "x" + std::to_string(pt->CThreadTransferSrcDstAccessOrder[3]) + "x" +
           std::to_string(pt->CThreadTransferSrcDstAccessOrder[4]) + "x" + std::to_string(pt->CThreadTransferSrcDstAccessOrder[5]) + "_";
...
static std::string get_definition_string_from_tunable(const tunable_dyn_conv_fwd_v4r5_nchw_kcyx_nkhw *pt)
{
    std::string out;
    ...
    out += " -DCK_PARAM_ABlockTransferThreadSliceLengths_GK_GM0_GM10_GM11=" + std::to_string(pt->ABlockTransferThreadSliceLengths_GK_GM0_GM10_GM11[0]) + ","
    ...
    out += " -DCK_PARAM_ABlockTransferThreadClusterLengths_GK_GM0_GM10_GM11=" + std::to_string(pt->ABlockTransferThreadClusterLengths_GK_GM0_GM10_GM11[0]) + ","
    ...
    out += " -DCK_PARAM_ABlockTransferThreadClusterArrangeOrder=" + std::to_string(pt->ABlockTransferThreadClusterArrangeOrder[0]) + ","
    ...
    out += " -DCK_PARAM_ABlockTransferSrcAccessOrder=" + std::to_string(pt->ABlockTransferSrcAccessOrder[0]) + ","
    ...
    out += " -DCK_PARAM_ABlockTransferSrcVectorDim=" + std::to_string(pt->ABlockTransferSrcVectorDim);
    out += " -DCK_PARAM_ABlockTransferSrcScalarPerVector=" + std::to_string(pt->ABlockTransferSrcScalarPerVector);
    out += " -DCK_PARAM_ABlockTransferDstScalarPerVector_GM11=" + std::to_string(pt->ABlockTransferDstScalarPerVector_GM11);
    out += " -DCK_PARAM_AThreadTransferSrcResetCoordinateAfterRun=" + std::to_string(pt->AThreadTransferSrcResetCoordinateAfterRun);

    out += " -DCK_PARAM_BBlockTransferThreadSliceLengths_GK_GN0_GN10_GN11=" + std::to_string(pt->BBlockTransferThreadSliceLengths_GK_GN0_GN10_GN11[0]) + ","
    ...
    out += " -DCK_PARAM_BBlockTransferThreadClusterLengths_GK_GN0_GN10_GN11=" + std::to_string(pt->BBlockTransferThreadClusterLengths_GK_GN0_GN10_GN11[0]) + ","
    ...
    out += " -DCK_PARAM_BBlockTransferThreadClusterArrangeOrder=" + std::to_string(pt->BBlockTransferThreadClusterArrangeOrder[0]) + ","
    ...
    out += " -DCK_PARAM_BBlockTransferSrcAccessOrder=" + std::to_string(pt->BBlockTransferSrcAccessOrder[0]) + ","
    ...
    out += " -DCK_PARAM_BBlockTransferSrcVectorDim=" + std::to_string(pt->BBlockTransferSrcVectorDim);
    out += " -DCK_PARAM_BBlockTransferSrcScalarPerVector=" + std::to_string(pt->BBlockTransferSrcScalarPerVector);
    out += " -DCK_PARAM_BBlockTransferDstScalarPerVector_GN11=" + std::to_string(pt->BBlockTransferDstScalarPerVector_GN11);
    out += " -DCK_PARAM_BThreadTransferSrcResetCoordinateAfterRun=" + std::to_string(pt->BThreadTransferSrcResetCoordinateAfterRun);

    out += " -DCK_PARAM_CThreadTransferSrcDstAccessOrder=" + std::to_string(pt->CThreadTransferSrcDstAccessOrder[0]) + ","
    ...
    out += " -DCK_PARAM_CThreadTransferSrcDstVectorDim=" + std::to_string(pt->CThreadTransferSrcDstVectorDim);
    out += " -DCK_PARAM_CThreadTransferDstScalarPerVector=" + std::to_string(pt->CThreadTransferDstScalarPerVector);
    ...
    ck::index_t nrepeat)
{
    ...
    const auto in_n_c_hi_wi_desc = make_dynamic_naive_tensor_descriptor_packed_v2(make_tuple(in_nchw_lengths[0], in_nchw_lengths[1], in_nchw_lengths[2], in_nchw_lengths[3]));
    const auto wei_k_c_y_x_desc = make_dynamic_naive_tensor_descriptor_packed_v2(make_tuple(wei_kcyx_lengths[0], wei_kcyx_lengths[1], wei_kcyx_lengths[2], wei_kcyx_lengths[3]));
    const auto out_n_k_ho_wo_desc = make_dynamic_naive_tensor_descriptor_packed_v2(make_tuple(out_nkhw_lengths[0], out_nkhw_lengths[1], out_nkhw_lengths[2], out_nkhw_lengths[3]));    
    ...
    void *b_gk_gn0_gn10_gn11_grid_desc_dev_buf = static_cast<void*>( static_cast<unsigned char *>(workspace_buf.GetDeviceBuffer()) + 1024 );
    void *c_gm10_bm0_bm1_gn10_bn0_bn1_grid_desc_dev_buf = static_cast<void*>( static_cast<unsigned char *>(workspace_buf.GetDeviceBuffer()) + 2048 );
    void *c_blockid_to_gm10_gn10_block_cluster_adaptor_dev_buf = static_cast<void*>( static_cast<unsigned char *>(workspace_buf.GetDeviceBuffer()) + 3072 );
    ...
    for(index_t i = 0; i < nrepeat; ++i)
    {
         ...
         handle->AddKernel(algo_name, network_config_1, program_name, kernel_name, vld, vgd1, param)(
                          static_cast<int>(in_nchw_lengths[0]), static_cast<int>(in_nchw_lengths[1]), static_cast<int>(in_nchw_lengths[2]), static_cast<int>(in_nchw_lengths[3]),
