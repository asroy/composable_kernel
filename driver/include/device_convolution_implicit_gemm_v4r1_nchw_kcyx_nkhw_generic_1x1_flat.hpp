...
#include "gridwise_convolution_implicit_gemm_v4r1_nchw_kcyx_nkhw_lds_double_buffer_generic_1x1_flat.hpp"
...
template <typename T,
          ...
          typename LeftPads,
          typename RightPads>
void device_convolution_implicit_gemm_v4r1_nchw_kcyx_nkhw_generic_1x1_flat(
    InDesc,
    ...
    ck::index_t nrepeat)
{
    ...
    static_assert(LeftPads{}[0] == 0 && LeftPads{}[1] == 0 && RightPads{}[0] == 0 &&
                      RightPads{}[1] == 0 && ConvStrides{}[0] == 1 && ConvStrides{}[1] == 1 &&
                      ConvDilations{}[0] == 1 && ConvDilations{}[1] == 1 && Hi == Ho && Wo == Wo,
                  "this version only support pad is 0, stride, dilation is 1");

    constexpr auto gridwise_conv =
        GridwiseConvolutionImplicitGemm_v4r1_nchw_kcyx_nkhw_lds_double_buffer_generic_1x1_flat<
            BlockSize,
            T,
            T,
