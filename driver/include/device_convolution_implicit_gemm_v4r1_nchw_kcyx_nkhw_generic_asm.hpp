...
template <typename T,
          ...
          typename LeftPads,
          typename RightPads>
void device_convolution_implicit_gemm_v4r1_nchw_kcyx_nkhw_generic_asm(InDesc,
                                                                          ...
                                                                          ck::index_t nrepeat)
{
    ...
    //       out_nkhw_device_buf.GetDeviceBuffer());
    {
        ...
        HIP_CALL(hipModuleLoad(&module, "igemm_v4r1_generic.co"));
        HIP_CALL(hipModuleGetFunction(&kernel_func, module, "igemm_v4r1_generic"));
        struct
        {
            T* __pack_0;
            T* p_in_global;
