...
static tunable_dyn_conv_fwd_v4r4_nchw_kcyx_nkhw   default_tunable_dyn_conv_fwd_v4r4_nchw_kcyx_nkhw = {256,
	                                                                                        128, 128, 8,  
												4, 4, 1,
                                                                                                8, 8, 2, 2,
                                                                                                {4,1,1}, 
...
static tunable_dyn_conv_fwd_v4r5_nchw_kcyx_nkhw   default_tunable_dyn_conv_fwd_v4r5_nchw_kcyx_nkhw = {256,
                                                                                                128, 32, 8,
                                                                                                4, 4, 1,
                                                                                                2, 2, 8, 8,
                                                                                                {4,1,1,1},
...
static inline int conv_hw_out_size(int hw_in_size, int leftPad, int rightPad, int dilation, int yx_size, int stride) 
{
