...
#include "gridwise_convolution_implicit_gemm_v4r1_nchw_kcyx_nkhw_lds_double_buffer_generic_nkc.hpp"
...
template <typename T,
          ...
          typename LeftPads,
          typename RightPads>
void device_convolution_implicit_gemm_v4r1_nchw_kcyx_nkhw_generic_nkc(InDesc,
                                                                      ...
                                                                      ck::index_t nrepeat)
{
    ...
    constexpr auto gridwise_conv =
        GridwiseConvolutionImplicitGemm_v4r1_nchw_kcyx_nkhw_lds_double_buffer_generic_nkc<
            BlockSize,
            T,
            T,
            TensorLengths_Hi_Wi_Y_X_Ho_Wo,
            ConvStrides,
            ConvDilations,
            LeftPads,
            RightPads,
