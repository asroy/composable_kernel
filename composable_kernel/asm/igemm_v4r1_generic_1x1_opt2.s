...
.macro .v_in_load_e_n1_b_n2 v_dst, s_p_in, v_in_os, s_in_diff_n1, s_in_diff_n2, v_flag, s_tmp4
    .v_clear_nc \v_dst, 8
    ...
    s_add_u32 s[\s_tmp4], s[\s_p_in], s[\s_in_diff_n1]
    s_addc_u32 s[\s_tmp4+1], s[\s_p_in+1], 0
    ; {0,1,0,0}
...
.macro .v_wei_load_e_k v_dst, s_p_wei, v_wei_os, s_wei_diff_k, s_tmp2
    global_load_dwordx4 v[\v_dst+0:\v_dst+3], v[\v_wei_os:\v_wei_os+1], s[\s_p_wei:\s_p_wei+1]
    s_add_u32 s[\s_tmp2], s[\s_p_wei], s[\s_wei_diff_k]
...
.macro .v_out_write_k0_k1_n1_b_n2 v_src, s_p_out, v_out_os, s_out_diff_k0, s_out_diff_k1, s_out_diff_n1, s_out_diff_n2, s_tmp4
    .v_write4d_2_4_2_4_strided \v_src, \s_p_out, \v_out_os, \s_out_diff_n2, \s_out_diff_n1, \s_out_diff_k1, \s_out_diff_k0, \s_tmp4
.endm
...
.set s_wei_diff_k,          29
.set s_wei_stride,          30
.set s_out_diff_k0,         31
.set s_out_diff_k1,         32
.set s_out_diff_n1,         33
.set s_out_diff_n2,         34
.set s_kitr,                35
.set s_tmp,                 36
.set s_end,                 39
...
igemm_v4r1_generic_1x1:
    ...
    s_mul_i32 s[s_out_diff_k1], s[s_ho], s[s_wo]
    s_lshl_b32 s[s_out_diff_k0], s[s_out_diff_k1], 6
    s_mul_i32 s[s_out_diff_n2], s[s_k], s[s_out_diff_k1]
    s_lshl_b32 s[s_out_diff_n1], s[s_out_diff_n2], 2

    s_lshr_b32 s[s_tmp], s[s_n], 3                          ; N0 = N / (N1 * N2);
    s_mul_i32 s[s_tmp+1], s[s_out_diff_k1], s[s_tmp]        ; B = N0 * Ho * Wo;
    ...
    .v_u32_div_vs 11, 1, s_out_diff_k1, v_tmp, s_tmp
    v_mul_lo_u32 v[v_tmp], s[s_out_diff_k1], v[11]
    ...
    s_mul_i32 s[s_in_diff_n2], s[s_tmp+1], s[s_c]
    v_mul_lo_u32 v[v_tmp], s[s_in_diff_n2], v[11]
    ...
    s_lshl_b32 s[s_wei_diff_k], s[s_c], 2
    ...
    .v_u32_div_vs 21, v_out_ib, s_out_diff_k1, v_tmp, s_tmp
    v_mul_lo_u32 v[v_tmp+1], s[s_out_diff_k1], v21
    ...
    s_mul_i32 s[s_tmp], s[s_k], s[s_out_diff_k1]
    ...
    s_lshl_b32 s[s_out_diff_k0], s[s_out_diff_k0], 2
    v_lshl_or_b32 v[v_tmp], v[v_out_ik0], 6, v[v_out_ik1]
    s_lshl_b32 s[s_out_diff_n1], s[s_out_diff_n1], 2
    v_mul_lo_u32 v[v_tmp+1], s[s_out_diff_k1], v[v_tmp]
    s_lshl_b32 s[s_out_diff_n2], s[s_out_diff_n2], 2
    v_add_u32 v[v_out_os], v[v_out_os], v[v_tmp+1]
    s_lshl_b32 s[s_out_diff_k1], s[s_out_diff_k1], 2
    ...
    s_cbranch_scc0 L_igemm_v4r1_generix_1x1_fma_end
...
L_igemm_v4r1_generix_1x1_fma_body:
    .itr_k = 0
    .nk = 16
    .rept (.nk - 1)
        .if .itr_k == 0
    ...
    s_cmp_gt_i32 s[s_kitr], 0
    s_cbranch_scc0 L_igemm_v4r1_generix_1x1_fma_last
    ; load input from global
    .v_in_load_e_n1_b_n2 v_b, s_p_in, v_in_os, s_in_diff_n1, s_in_diff_n2, v_flag, s_tmp
    s_add_u32 s[s_p_in], s[s_p_in], s[s_in_stride]
    s_addc_u32 s[s_p_in+1], s[s_p_in+1], 0
    ...
    ; #4
    .v_fma_4x4_s8 v_c+36, v_la+4, v_lb+4
    s_branch L_igemm_v4r1_generix_1x1_fma_body

L_igemm_v4r1_generix_1x1_fma_last:
    ; #4
    .v_fma_4x4_s8 v_c+36, v_la+4, v_lb+4

L_igemm_v4r1_generix_1x1_fma_end:
    .v_fma_8x8_nk 16, v_c, v_la, v_lb, v_lda_os, v_ldb_os, 8192, 512, 0, 512

L_igemm_v4r1_generix_1x1_fma_out:
    .v_out_write_k0_k1_n1_b_n2 v_c, s_p_out, v_out_os, s_out_diff_k0, s_out_diff_k1, s_out_diff_n1, s_out_diff_n2, s_tmp
