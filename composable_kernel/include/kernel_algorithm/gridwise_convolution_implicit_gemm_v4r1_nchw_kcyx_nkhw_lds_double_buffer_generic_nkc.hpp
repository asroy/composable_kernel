...
struct GridwiseConvolutionImplicitGemm_v4r1_nchw_kcyx_nkhw_lds_double_buffer_generic_nkc
{
                        ...
                        index_t C) const
    {
        ...
        auto in_n_c_hi_wi_global_desc = dynamic_native_tensor_descriptor_packed(N, C, Hi, Wi);

        auto in_n_c_hip_wip_global_desc = dynamic_transform_tensor_descriptor(
            in_n_c_hi_wi_global_desc,
            make_tuple(dynamic_passthrough(N),
                       dynamic_passthrough(C),
        ...
        constexpr index_t Hip = Pad<Sequence<Hi, Wi>, LeftPads, RightPads>::GetUpperLengths()[0];
        constexpr index_t Wip = Pad<Sequence<Hi, Wi>, LeftPads, RightPads>::GetUpperLengths()[1];

        auto in_n0_n1_n2_c_y_ho_x_wo_global_desc = dynamic_transform_tensor_descriptor(
            in_n_c_hip_wip_global_desc,
            make_tuple(dynamic_unmerge(N0, N1, N2),
                       dynamic_passthrough(C),
        ...
        auto in_e_n1_b_n2_global_desc = dynamic_transform_tensor_descriptor(
            in_n0_n1_n2_c_y_ho_x_wo_global_desc,
            make_tuple(dynamic_merge(C, Y, X),
                       PassThrough<N1>{},
                       dynamic_merge(N0, Ho, Wo),
                       PassThrough<N2>{}),
        ...
        //     block tensor in LDS memory, dst of blockwise copy
        //     be careful of LDS alignment
        auto wei_e_k_block_desc = make_native_tensor_descriptor_aligned(
...
#pragma unroll
        ...
        // copy output: register to global memory
        {
            ...
            auto out_k0_k1_n1_b_n2_thread_desc = make_native_tensor_descriptor_packed(
                Sequence<GemmMRepeat, GemmMPerThreadSubC, N1, 1, N2>{});

            //     global output tensor
            auto out_n_k_ho_wo_global_desc = dynamic_native_tensor_descriptor_packed(N, K, Ho, Wo);

            auto out_n0_n1_n2_k0_k1_ho_wo_global_desc = dynamic_transform_tensor_descriptor(
                out_n_k_ho_wo_global_desc,
                make_tuple(dynamic_unmerge(N0, N1, N2),
                           dynamic_unmerge(K0, K1),
                           PassThrough<Ho>{},
                           PassThrough<Wo>{}),
                make_tuple(Sequence<0>{}, Sequence<1>{}, Sequence<2>{}, Sequence<3>{}),
            ...
            auto out_k0_k1_n1_b_n2_global_desc = dynamic_transform_tensor_descriptor(
                out_n0_n1_n2_k0_k1_ho_wo_global_desc,
                make_tuple(dynamic_passthrough(K0),
                           PassThrough<K1>{},
                           PassThrough<N1>{},
                           dynamic_merge(N0, Ho, Wo),
                           PassThrough<N2>{}),
