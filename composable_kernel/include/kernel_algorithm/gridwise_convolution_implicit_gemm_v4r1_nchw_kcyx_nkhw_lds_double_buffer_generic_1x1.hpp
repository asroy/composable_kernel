#ifndef CK_GRIDWISE_CONVOLUTION_IMPLICIT_GEMM_V4R1_NCHW_KCYX_NKHW_LDS_DOUBLE_BUFFER_GENERIC_1X1_HPP
#define CK_GRIDWISE_CONVOLUTION_IMPLICIT_GEMM_V4R1_NCHW_KCYX_NKHW_LDS_DOUBLE_BUFFER_GENERIC_1X1_HPP
...
struct GridwiseConvolutionImplicitGemm_v4r1_nchw_kcyx_nkhw_lds_double_buffer_generic_1x1
{
                        ...
                        index_t PadW) const
    {
        ...
        auto in_n_c_hip_wip_global_desc = dynamic_transform_tensor_descriptor(
            ...
            make_tuple(dynamic_passthrough(N),
                       ...
                       dynamic_pad(dynamic_sequence(Hi, Wi),
                                   dynamic_sequence(PadH, PadW),
                                   dynamic_sequence(PadH, PadW))),
            make_tuple(Sequence<0>{}, Sequence<1>{}, Sequence<2, 3>{}),
            make_tuple(Sequence<0>{}, Sequence<1>{}, Sequence<2, 3>{}));

        const index_t Hip = Hi + 2 * PadH;
        const index_t Wip = Wi + 2 * PadW;
        ...
        auto in_n0_n1_n2_c_y_ho_x_wo_global_desc = dynamic_transform_tensor_descriptor(
            ...
            make_tuple(dynamic_unmerge(N0, N1, N2),
                       dynamic_passthrough(C),
                       dynamic_embed(
                           Hip, dynamic_sequence(1, Ho), dynamic_sequence(DilationH, StrideH, 0)),
                       dynamic_embed(
                           Wip, dynamic_sequence(1, Wo), dynamic_sequence(DilationW, StrideW, 0))),
        ...
        auto in_e_n1_b_n2_global_desc = dynamic_transform_tensor_descriptor(
            ...
            make_tuple(dynamic_merge(C, 1, 1),
                       PassThrough<N1>{},
        ...
        // copy output: register to global memory
        {
            ...
            auto out_n0_n1_n2_k0_k1_ho_wo_global_desc = dynamic_transform_tensor_descriptor(
                ...
                make_tuple(dynamic_unmerge(N0, N1, N2),
                           ...
                           dynamic_passthrough(Ho),
                           dynamic_passthrough(Wo)),
                make_tuple(Sequence<0>{}, Sequence<1>{}, Sequence<2>{}, Sequence<3>{}),
