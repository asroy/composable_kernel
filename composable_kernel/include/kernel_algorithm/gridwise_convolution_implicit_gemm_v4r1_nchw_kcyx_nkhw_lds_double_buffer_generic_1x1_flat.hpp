#ifndef CK_GRIDWISE_CONVOLUTION_IMPLICIT_GEMM_V4R1_NCHW_KCYX_NKHW_LDS_DOUBLE_BUFFER_GENERIC_1X1_FLAT_HPP
#define CK_GRIDWISE_CONVOLUTION_IMPLICIT_GEMM_V4R1_NCHW_KCYX_NKHW_LDS_DOUBLE_BUFFER_GENERIC_1X1_FLAT_HPP
...
struct GridwiseConvolutionImplicitGemm_v4r1_nchw_kcyx_nkhw_lds_double_buffer_generic_1x1_flat
{
                        ...
                        index_t C) const
    {
        ...
        const index_t B = N0 * Hi * Wi;

        const index_t E = C * 1 * 1;

        // sanity-check for vectorized memory load
        // static_assert((Wi == 1 || (ConvStrideW == 1 || InBlockCopySrcDataPerRead_B == 1)) &&
        ...
        auto in_n0_n1_n2_c_ho_wo_global_desc = dynamic_transform_tensor_descriptor(
            in_n_c_hi_wi_global_desc,
            make_tuple(dynamic_unmerge(N0, N1, N2),
                       dynamic_passthrough(C),
                       dynamic_passthrough(Hi),
                       dynamic_passthrough(Wi)),
        ...
        auto in_e_n1_b_n2_global_desc = dynamic_transform_tensor_descriptor(
            in_n0_n1_n2_c_ho_wo_global_desc,
            make_tuple(dynamic_passthrough(C),
                       PassThrough<N1>{},
                       dynamic_merge(N0, Hi, Wi),
                       PassThrough<N2>{}),
...
#pragma unroll
        ...
        // copy output: register to global memory
        {
            ...
            auto out_n_k_ho_wo_global_desc = dynamic_native_tensor_descriptor_packed(N, K, Hi, Wi);
