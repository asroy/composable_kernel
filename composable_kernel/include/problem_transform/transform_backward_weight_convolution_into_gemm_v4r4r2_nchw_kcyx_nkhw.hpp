...
transform_bakcward_weight_convolution_into_gemm_v4r4r2_nchw_kcyx_nkhw_pad(
    ...
    Number<GemmK1Value>)
{
    ...
    // weight tensor
    const auto wei_gemmm_gemmn_grid_desc = transform_dynamic_tensor_descriptor(
    ...
    // output tensor
    const auto out_gemmk_gemmm_grid_desc = transform_dynamic_tensor_descriptor(
