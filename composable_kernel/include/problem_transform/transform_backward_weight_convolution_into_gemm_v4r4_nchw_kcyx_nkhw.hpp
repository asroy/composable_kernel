...
__host__ __device__ constexpr auto transform_backward_weight_convolution_into_gemm_v4r4_nchw_kcyx_nkhw_pad(
    ...
    const InRightPads& in_right_pads)
{
    ...
    // weight tensor
    const auto wei_gemmm_gemmn_global_desc = transform_dynamic_tensor_descriptor(
    ...
    // output tensor
    const auto out_gemmk_gemmm_global_desc = transform_dynamic_tensor_descriptor(
    ...
    return make_tuple(
        out_gemmk_gemmm_global_desc, in_gemmk_gemmn_global_desc, wei_gemmm_gemmn_global_desc);
}
