...
void device_dynamic_convolution_backward_weight_implicit_gemm_v4r4r2_xdlops_nchw_kcyx_nkhw(
    ...
    ck::index_t nrepeat)
{
    ...
    const auto descs =
        transform_bakcward_weight_convolution_into_gemm_v4r4r2_nchw_kcyx_nkhw_pad(wei_k_c_y_x_desc,
                                                                          in_n_c_hi_wi_desc,
                                                                          out_n_k_ho_wo_desc,
                                                                          conv_strides,
                                                                          conv_dilations,
