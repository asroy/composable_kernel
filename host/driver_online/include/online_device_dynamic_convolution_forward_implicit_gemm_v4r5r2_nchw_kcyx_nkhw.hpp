...
static std::string
get_network_config_string_from_tunable(const tunable_dyn_conv_fwd_v4r5r2_nchw_kcyx_nkhw* pt)
{
    std::string out("TUN_");
...
static std::string
get_definition_string_from_tunable(const tunable_dyn_conv_fwd_v4r5r2_nchw_kcyx_nkhw* pt)
{
    std::string out;
    ...
    ck::index_t nrepeat)
{
    ...
    std::string program_name = "dynamic_convolution_forward_implicit_gemm_v4r5r2_nchw_kcyx_nkhw.cpp";
